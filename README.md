...
## ⚠️ Disclaimer / Penyangkalan / 免责声明

**EN:** This project is for **educational purposes only**. Trading cryptocurrencies involves significant risk. Use this software at your own risk. The authors and contributors are not responsible for any financial losses or damages.

**ID:** Proyek ini hanya untuk **tujuan edukasi**. Trading cryptocurrency melibatkan risiko yang signifikan. Gunakan perangkat lunak ini dengan risiko Anda sendiri. Penulis dan kontributor tidak bertanggung jawab atas kerugian atau kerusakan finansial apa pun.

**CN:** 该项目仅用于 **教育目的**。交易加密货币涉及重大风险。使用此软件的风险由您自行承担。作者和贡献者对任何财务损失或损害不承担任何责任。
