...
def health_check():
    ...
    return jsonify({
        ...
        'service': 'SolSniperX Backend v2.8.0 (Snipe-Only & Contract Analysis Upgrade)',
        'features': ['Token Scanner', 'AI Analysis', 'Trading Signals', 'Local Storage', 'RugCheck API', 'JITO Support', 'Dynamic JITO Tip']
    })
