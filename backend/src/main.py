...
def health_check():
    ...
    return jsonify({
        ...
        'service': 'SolSniperX Backend v3.1.0 (Advanced Filtering Upgrade)',
        'features': ['Token Scanner', 'AI Analysis', 'Trading Signals', 'Local Storage', 'RugCheck API', 'JITO Support', 'Dynamic JITO Tip', 'Consolidated Production Ready', 'Advanced Mempool Filtering']
    })
