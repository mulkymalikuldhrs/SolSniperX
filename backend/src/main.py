...
def health_check():
    ...
    return jsonify({
        ...
        'service': 'SolSniperX Backend v2.6.0 (Consolidated & Advanced Autonomous Upgrade)',
        'features': ['Token Scanner', 'AI Analysis', 'Trading Signals', 'Local Storage', 'RugCheck API', 'JITO Support']
    })
