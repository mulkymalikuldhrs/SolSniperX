...
def health_check():
    ...
    return jsonify({
        ...
        'service': 'SolSniperX Backend v3.2.0 (Ultimate Autonomous Upgrade)',
        'features': ['Token Scanner', 'AI Analysis', 'Trading Signals', 'Local Storage', 'RugCheck API', 'JITO Support', 'Dynamic JITO Tip', 'Consolidated Production Ready', 'Advanced Mempool Filtering', 'Service Watchdog', 'Autonomous Resilience']
    })
