...
def health_check():
    ...
    return jsonify({
        ...
        'service': 'SolSniperX Backend v2.4.0 (Advanced Autonomous Upgrade)',
        'features': ['Token Scanner', 'AI Analysis', 'Trading Signals', 'Autonomous Mode', 'Real Solana Integration', 'Multiple TP Tiers', 'VWAP Filter', 'JITO Tip Management', 'RugCheck Integration']
    })
