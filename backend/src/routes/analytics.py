...
def get_dashboard_data():
    ...
    try:
        ...
        # Get wallet info
        wallet_info = run_async(wallet_service.get_wallet_info())

        # Get trending tokens
        trending_tokens = run_async(data_fetcher.get_all_tokens())
        ...
        for pos in active_positions:
            try:
                ...
                token_data = run_async(data_fetcher.get_token_by_address(pos['token_address']))
                if token_data:
