    ...
    async def _trade_loop(self):
        while self.trading_enabled:
            try:
                ...
                logger.exception(f"AutoTrader: Unexpected error in trade loop: {e}")
    ...
    async def _analyze_and_buy(self, token: Dict):
        ...
        if analysis and analysis['recommendation'] == "Buy" and \
           ...
           analysis['risk_assessment'] != "High":
            ...
            logger.info(f"AutoTrader: AI recommends BUY for {token.get('symbol', token_address)} (Score: {analysis['probability_score']}).")
