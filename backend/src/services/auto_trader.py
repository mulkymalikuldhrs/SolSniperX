    ...
    async def _analyze_and_buy(self, token: Dict):
        ...
        if analysis and analysis['recommendation'] == "Buy" and \
           ...
           analysis['risk_assessment'] != "High":
            ...
            logger.info(f"AutoTrader: AI recommends BUY for {token.get('symbol', token_address)} (Score: {analysis['probability_score']}, Risk: {analysis['risk_assessment']}). Proceeding to buy.")
            ...
            if buy_result.get("success"):
                ...
                logger.info(f"AutoTrader: Buy transaction sent for {token_address}, waiting for finality...")
