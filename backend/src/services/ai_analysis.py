...
class AIAnalysisService:
    ...
    def _create_analysis_prompt(self, token_data: Dict) -> str:
        ...
        IMPORTANT: Thoroughly evaluate the provided "Social Links" (website, Telegram, Twitter). Tokens with valid, active social presence are generally higher quality.
