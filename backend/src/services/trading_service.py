...
class TradingService:
    ...
    async def execute_buy_order(self, token_address: str, amount_sol: float, slippage: float = 1.0, token_symbol: Optional[str] = None, price_usd: Optional[float] = None) -> Dict:
        """
    ...
    async def execute_sell_order(self, token_address: str, amount_tokens: float, slippage: float = 1.0, token_symbol: Optional[str] = None, price_usd: Optional[float] = None) -> Dict:
        """
