      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-green-400">{dashboardStats?.totalTrades || 0} total trades</span>
          </div>
        </motion.div>
          ...
          <div className="space-y-4">
            {activePositions.length > 0 ? (
              activePositions.map((position, index) => {
                const pnlPercent = position.buy_price > 0
                  ? ((position.highest_price - position.buy_price) / position.buy_price) * 100
                  : 0;
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="font-semibold">{position.token_symbol || position.token_address.slice(0, 8)}</p>
                        <p className="text-sm text-muted-foreground">
                          {position.buy_amount_sol?.toFixed(3)} SOL
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="font-mono text-sm">${position.buy_price.toFixed(8)}</p>
                    </div>

                    <div className="text-center">
                      <p className="text-sm text-muted-foreground">Highest</p>
                      <p className="font-mono text-sm">${position.highest_price?.toFixed(8)}</p>
                    </div>
